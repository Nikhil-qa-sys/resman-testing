...
const qaTestData = {
  'QA-08': {
    ...
    // The precondition: QA-08 creates its own building, unit type and unit before
    // the applicant, so the unit it moves the resident into is guaranteed vacant and
    // the run never depends on a record another case left behind.
    building: {
      namePrefix: 'qaBld',
      floors: '4',
    ...
    unitCount: 1,
    // Typed into the dialog the move-in prerequisite raises when it is overridden.
    moveInOverrideReason: 'QA automation move-in override',
  },
}
...
const rcTestData: typeof qaTestData = {
  'QA-08': {
    ...
    unitCount: 1,
    moveInOverrideReason: 'RC automation move-in override',
  },
}
...
const regressionTestData: typeof qaTestData = {
  'QA-08': {
    ...
    // this case runs against on regression.
    ...
    unitCount: 1,
    moveInOverrideReason: 'Regression automation move-in override',
  },
}
